...
var _ = user_center.GoUnusedProtection__
...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  LogoutResponse Logout(LogoutRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := user_center.NewUserCenterClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "Register":
		...
		argvalue0 := user_center.NewRegisterRequest()
	...
	case "Login":
		...
		argvalue0 := user_center.NewLoginRequest()
	...
	case "Logout":
		...
		argvalue0 := user_center.NewLogoutRequest()
